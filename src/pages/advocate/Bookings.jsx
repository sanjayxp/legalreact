...
import { ChevronLeft, ChevronRight, Check, X as XIcon, Phone, Video, Building2, UserPlus, ArrowRight, Inbox, CalendarDays, BellRing, CalendarCheck2, History, Mail, Download, Globe2, MapPin, IndianRupee } from 'lucide-react';
  ...
  return (
    <AdvocateShell>
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="mt-1 text-[14.5px] text-ink-500">Matters open to every advocate, the ones you've taken on, and your consultation requests. Working hours live in Settings.</p>
      </motion.div>
