// lucide-react removed brand marks over trademark concerns, so the two we
// link to are carried here. Both take the current text colour, so they inherit
// hover states like any other icon.
